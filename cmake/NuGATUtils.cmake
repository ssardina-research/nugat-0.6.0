...
macro(nugat_combine_scanner output)
    add_custom_command(OUTPUT "${output}"
      ...
      ARGS "${NUGAT_SOURCE_DIR}/cmake/combine_grammar.py"
      "--output" "${output}" ${ARGN}
      DEPENDS ${ARGN} "${NUGAT_SOURCE_DIR}/cmake/combine_grammar.py"
...
macro(nugat_add_pkg_lib)
    nugat_get_pkg_name(_curpkg)
    nugat_add_pkg(${_curpkg} core ${ARGN})
endmacro()

# like the above, but adds to the "shell" library
macro(nugat_add_pkg_shell)
    nugat_get_pkg_name(_curpkg)
    nugat_add_pkg(${_curpkg} shell ${ARGN})
endmacro()

# like the above, but adds to the "addonscore" library
macro(nugat_add_pkg_addon)
    nugat_get_pkg_name(_curpkg)
    nugat_add_pkg(${_curpkg} addonscore ${ARGN})
endmacro()

macro(nugat_add_pkg_headers)
    foreach(_a ${ARGN})
