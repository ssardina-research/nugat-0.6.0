/**CHeaderFile*****************************************************************
  ...
  FileName    [ PrinterGame_private.h ]

  PackageName [ game.walkers ]

  Synopsis    [ Private and protected interface of class 'PrinterGame'. ]
...
#ifndef __PRINTER_GAME_PRIVATE_H__
#define __PRINTER_GAME_PRIVATE_H__
...
/**Struct**********************************************************************
  ...
  Synopsis    [ PrinterGame class definition derived from class
                PrinterBase. ]
...
******************************************************************************/
typedef struct PrinterGame_TAG
{
...
EXTERN void printer_game_deinit ARGS((PrinterGame_ptr self));

EXTERN int printer_game_print_node ARGS((PrinterBase_ptr self,
                                         node_ptr n,
                                         int priority));

#endif /* __PRINTER_GAME_PRIVATE_H__ */
